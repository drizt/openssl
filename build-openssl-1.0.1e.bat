...
::    Revision: $Id: build-openssl-1.0.1e.bat 4596 2013-10-25 20:19:20Z stathis $
::
	...
	for %%a in (x86 x64) do (
		...
		for %%b in (debug release) do (
			...
			if exist "!SRC_DIST_DIR!" (
				...
				xcopy /E /Q /Y !SRC_DIST_DIR!\include\*.* !DST_DIST_DIR!\include\
...
pushd !PROJECT_INSTALL_DIR!
	...
	echo ====================================================================================================================== >> !README!
	echo These are the pre-built OpenSSL Libraries v!PROJECT_VERSION!. They are compiled with Cygwin/MSVC  >> !README!
	...
	echo. >> !README!
	echo ====================================================================================================================== >> !README!
	echo These prebuild OpenSSL binaries are not well tested and you are using them at your own risk. >> !README!
...
SET BTDIR=!BUILD_PROJECT!-!__BUILD!-!__LINK!-win!BITS!
